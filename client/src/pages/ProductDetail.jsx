      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "3rem", background: "#fff", borderRadius: "20px", boxShadow: "0 4px 24px rgba(0,0,0,0.08)", padding: "2.5rem", marginBottom: "1.5rem" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
            ...
            <span style={{ color: "#9ca3af", fontSize: "0.85rem" }}>({approvedReviews.length} reviews)</span>
            <button
            ...
            <div>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.5rem" }}>
                <div>
                  ...
                  <p style={{ margin: "3px 0 0", fontSize: "0.82rem", color: "#9ca3af" }}>{approvedReviews.length} verified review{approvedReviews.length !== 1 ? 's' : ''}</p>
                </div>
